...
let loadCities = () => {
    if (citySearch) {
        ...
        for (var i = 0; i < citySearch.length; i++) {
            ...
            liElement.innerHTML = "<button type='button' class='list-group-item list-group-item-action' attr='"+citySearch[i]+"'>" + citySearch[i] + "</button>";
    ...
    let searchCity = () => {
       ...
       localStorage.setItem('city', JSON.stringify(citySearch));
        let current = JSON.parse(localStorage.getItem('city'));
        console.log(current);
